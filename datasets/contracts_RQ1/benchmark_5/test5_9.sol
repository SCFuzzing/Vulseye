...
contract test {
    ...
    function invest2(uint _v1, uint _v2, uint _v3, uint _v4, uint _v5, uint _v6) payable public {
        ...
        if (v1 >= 6 && v1 <= 17 && v2 >= 6 && v2 <= 16 && v3 >= 4 && v3 <= 21 && v4 >= 13 && v4 <= 26 && v5 >= 3 && v5 <= 8 && v6 >= 5 && v6 <= 14) {
            invest1();
        }
    }
    ...
    function invest3(uint _v1, uint _v2, uint _v3, uint _v4, uint _v5, uint _v6) payable public {
        ...
        if (v1 >= 15 && v1 <= 23 && v2 >= 24 && v2 <= 30 && v3 >= 17 && v3 <= 22 && v4 >= 5 && v4 <= 17 && v5 >= 15 && v5 <= 19 && v6 >= 14 && v6 <= 44) {
            v1 = _v1 + _v2;
            v2 = _v1 + _v2 + _v3;
            v4 = _v1 + _v2 + _v3 + _v4;
        }
    ...
    function invest4(uint _v1, uint _v2, uint _v3, uint _v4, uint _v5, uint _v6) payable public {
        ...
        if (v1 >= 4 && v1 <= 10 && v2 >= 13 && v2 <= 28 && v3 >= 11 && v3 <= 19 && v4 >= 14 && v4 <= 22 && v5 >= 4 && v5 <= 9 && v6 >= 44 && v6 <= 64) {
            v1 = _v1 + _v2;
            v2 = _v1 + _v2 + _v3;
        }
    }
    ...
    function invest6(uint _v1, uint _v2, uint _v3, uint _v4, uint _v5, uint _v6) payable public {
        ...
        if (v1 >= 21 && v1 <= 30 && v2 >= 13 && v2 <= 16 && v3 >= 3 && v3 <= 10 && v4 >= 14 && v4 <= 31 && v5 >= 4 && v5 <= 8 && v6 >= 13 && v6 <= 23) {
            v1 = _v1 + _v2;
            v2 = _v1 + _v2 + _v3;
        }
    }
    ...
    function invest7(uint _v1, uint _v2, uint _v3, uint _v4, uint _v5, uint _v6) payable public {
        ...
        if (v1 >= 13 && v1 <= 21 && v2 >= 4 && v2 <= 7 && v3 >= 2 && v3 <= 14 && v4 >= 13 && v4 <= 21 && v5 >= 5 && v5 <= 22 && v6 >= 24 && v6 <= 54) {
    ...
    function withdrawBalance(uint _v1, uint _v2, uint _v3, uint _v4, uint _v5, uint _v6) public {
        ...
        if (v1 >= 4 && v1 <= 12 && v2 >= 2 && v2 <= 5 && v3 >= 3 && v3 <= 15 && v4 >= 9 && v4 <= 18 && v5 >= 14 && v5 <= 23 && v6 >= 19 && v6 <= 23) {
