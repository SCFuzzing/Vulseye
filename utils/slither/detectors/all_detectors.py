...
from .mydetectors.reentrancy import ReentrancyNew
from .mydetectors.controlled_delegatecall import DangerousDelegateCall
from .mydetectors.lock_ether import LockEther
from .mydetectors.dangerous_delegatecall import DangerousDelegateCallNew
from .mydetectors.timestamp_dependency import TimestampTest
from .mydetectors.blocknumber_dependency import BlockNumber
from .mydetectors.arbitrary_eth_sent import ArbitraryEthSent
from .mydetectors.suicidal_contract import SuicidalContract
