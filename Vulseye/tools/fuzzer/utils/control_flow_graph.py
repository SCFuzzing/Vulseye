...
class ControlFlowGraph:
    ...
    def build(self, bytecode, evm_version):
        ...
        while current_pc < len(bytecode):
            ...
            #TODO
            #动态判断 instead of 静态判断
            # if opcode in self.opcode_to_mnemonic[evm_version] and self.opcode_to_mnemonic[evm_version][opcode] in ["CALL","CREATE","SELFDESTRUCT", "SUICIDE"]:
